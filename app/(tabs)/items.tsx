...
export default function ItemsScreen() {
  ...
  const addItem = useOSStore(s => s.addItem);
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.row}>
              ...
              <Text style={[styles.itemPrice, { color: theme.textHigh }]}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {CATEGORIES.map(cat => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.chip,
                    category === cat && { backgroundColor: '#333' },
                  ]}
                  onPress={() => setCategory(cat)}
                >
                  <Text style={[
                    styles.chipText,
                    { color: category === cat ? '#FFF' : theme.textHigh },
                  ]}>
                    {cat}
                  </Text>
                </TouchableOpacity>
